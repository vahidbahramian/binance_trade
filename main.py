...
def main(client, currency, param):
    ...
    if back_test:
        ...
        c = {"BTC": [[date(2021, 1, 1), date(2021, 9, 1)]],
             "ETH": [[date(2021, 1, 1), date(2021, 9, 1)]],
             "XRP": [[date(2021, 1, 1), date(2021, 9, 1)]],
             "LTC": [[date(2021, 1, 1), date(2021, 9, 1)]],
             "TRX": [[date(2021, 1, 1), date(2021, 9, 1)]],
             "ADA": [[date(2021, 1, 1), date(2021, 9, 1)]],
             "ALGO": [[date(2021, 1, 1), date(2021, 9, 1)]],
             "MATIC": [[date(2021, 1, 1), date(2021, 9, 1)]]
             }
        for c, v in c.items():
            for i in v:
                currency = [c, "USDT"]
