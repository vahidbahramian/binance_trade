...
from MainCode.Strategy import ICHIMOKU_2_Strategy, ICHIMOKU_Strategy_HMA, ICHIMOKU_Strategy_HMA_Keltner
import pandas as pd
import numpy

import time
import datetime
from MainCode.Algorithm import OnlineAlgorithm
from MainCode.IO import FileWorking, CSVFiles
...
class Algo_4(Algo_3):
    ...
    def __init__(self, exchange_admin, exchange_user, currency, api):
        super().__init__(exchange_admin, currency)
